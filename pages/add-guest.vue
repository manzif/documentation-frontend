    ...
    <div class="mx-12">
      <v-row align="center" justify="center">
        <v-col cols="12" md="7" sm="6">
          ...
          <div class="line"></div>
          <h4 class="my-6">
            Hello, at this page you can add a guest to one of our application.
            When a user is added as a guest on the application he/she will
            automatically be able to view its APIs but he/she won't be able to
