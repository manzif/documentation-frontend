    ...
    <div class="mx-12">
      <v-row align="center" justify="center">
        <v-col cols="12" md="7" sm="6">
          ...
          <div class="line"></div>
          <h4 class="my-6">
            At this page you can create a developer. Only Admin are allowed to
            create other developers. The developer created will have permission
            to create, edit, view, and delete all his/her APIs.
          </h4>
